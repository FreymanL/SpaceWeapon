...
@onready var astropajo_enemy = load("res://scenes/astropajo.tscn")
@onready var cosmic_chimera_enemy = load("res://scenes/cosmic_chimera.tscn")
@onready var game_over_window = load("res://scenes/game_over.tscn")
@onready var level_completed_window = load("res://scenes/level_completed.tscn")
@onready var ability_handler = load("res://scenes/ability_handler.tscn")
@onready var ability_icon = load("res://scenes/ability_icon.tscn")
...
var MAX_COSMIC_CHIMERA = 2
var TARGET_COSMIC_CHIMERA = 6
...
func _ready():
	world_info = game_settings.get_key("mundo")
